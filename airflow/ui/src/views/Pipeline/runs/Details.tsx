      ...
      <table className="table">
        <tbody>
          ...
          <tr>
            ...
            <td>
              days: {dagDetails.dagRunTimeout ? dagDetails.dagRunTimeout.days : "null"}, 
              microseconds: {dagDetails.dagRunTimeout ? dagDetails.dagRunTimeout.microseconds : "null"}, 
              seconds: {dagDetails.dagRunTimeout ? dagDetails.dagRunTimeout.seconds : "null"}
            </td>
          </tr>
          <tr>
            <td>Tags</td>
            <td>
              {
                dagDetails.tags.map(tag =>
                  <a className="label label-info" style={{ margin: "3px 6px 3px 0" }}>
                    {tag.name}
                  </a>
                )
              }
