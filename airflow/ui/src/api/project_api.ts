...
// axios.defaults.baseURL = `https://exl.workbench.couture.ai/someuri/api/v1`;
...
export function useDagCode(fileToken: Dag['fileToken']) {
  ...
  return useQuery<string, Error>(
    'dagCode',
    (): Promise<string> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/dagSources/${fileToken}`),
    { refetchInterval },
  );
}
...
export function useDagDetails(dagId: Dag['dagId']) {
  ...
  return useQuery<DagDetails, Error>(
    'dagDetails',
    (): Promise<DagDetails> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/dags/${dagId}/details`),
  );
}
...
export function useDags({ offset = 0, limit, projectId }: PageProps) {
  return useQuery<DagsResponse, Error>(
    ['dags', offset],
    (): Promise<DagsResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/dags`, {
...
export function useConnections({ offset = 0, limit }: PageProps) {
  ...
  return useQuery<ConnectionsResponse, Error>(
    ['connections', offset],
    (): Promise<ConnectionsResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/connections`, {
      params: { offset, limit },
...
export function useAddConnection() {
  return useQuery<Connection, Error>(
    'connections',
    (): Promise<Connection> => axios.post(`https://exl.workbench.couture.ai/someuri/api/v1/connections`),
  );
}
...
export function DeleteConnection(connection_id: Connection['connection_id']) {
  return useQuery<Connection, Error>(
    'connections',
    (): Promise<Connection> => axios.delete(`https://exl.workbench.couture.ai/someuri/api/v1/connections/${connection_id}`),
  );
}
...
export function useVariables({ offset = 0, limit }: PageProps) {
  ...
  return useQuery<VariablesResponse, Error>(
    ['variables', offset],
    (): Promise<VariablesResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/variables`, {
      params: { offset, limit },
...
export function usePlugins({ offset = 0, limit }: PageProps) {
  ...
  return useQuery<PluginsResponse, Error>(
    ['plugins', offset],
    (): Promise<PluginsResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/plugins`, {
      params: { offset, limit },
...
export function usePools({ offset = 0, limit }: PageProps) {
  ...
  return useQuery<PoolsResponse, Error>(
    ['pools', offset],
    (): Promise<PoolsResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/pools`, {
      params: { offset, limit },
...
export function useAuditLogs({ offset = 0, limit }: PageProps) {
  ...
  return useQuery<AuditLogsResponse, Error>(
    ['pools', offset],
    (): Promise<AuditLogsResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/eventLogs`, {
      params: { offset, limit },
...
export function DeleteDag(dagId: Dag['dagId']) {
  return useQuery<Dag, Error>(
    'dag',
    (): Promise<Dag> => axios.delete(`https://exl.workbench.couture.ai/someuri/api/v1/dags/${dagId}`),
  );
}
...
export function useDagRuns(dagId: Dag['dagId'], dateMin?: string) {
  return useQuery<DagRunsResponse, Error>(
    ['dagRun', dagId],
    (): Promise<DagRunsResponse> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/dags/${dagId}/dagRuns${dateMin ? `?start_date_gte=${dateMin}` : ''}`),
    { refetchInterval },
  );
}
...
export function useTaskInstances(dagId: Dag['dagId'], dagRunId: DagRun['dagRunId'], dateMin?: string) {
  return useQuery<TaskInstancesResponse, Error>(
    ...
    (): Promise<TaskInstancesResponse> => (
      axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/dags/${dagId}/dagRuns/${dagRunId}/taskInstances${dateMin ? `?start_date_gte=${dateMin}` : ''}`)
    ),
  );
}
...
export function useConfig() {
  return useQuery<Config, Error>('config', (): Promise<Config> => axios.get(`https://exl.workbench.couture.ai/someuri/api/v1/config`));
}
...
export function useTriggerRun(dagId: Dag['dagId']) {
  ...
  return useMutation(
    (trigger: TriggerRunRequest) => axios.post(`https://exl.workbench.couture.ai/someuri/api/v1/dags/${dagId}/dagRuns`, humps.decamelizeKeys(trigger)),
    {
      onSettled: (res, error) => {
        if (error) {
          toast({
...
export function useSaveDag(dagId: Dag['dagId'], offset: number) {
  ...
  const toast = useToast();
  return useMutation(
    (updatedValues: Record<string, any>) => axios.patch(`https://exl.workbench.couture.ai/someuri/api/v1/dags/${dagId}`, humps.decamelizeKeys(updatedValues)),
    {
